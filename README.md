...
- **Secrets never in git.** Tokens and webhook secrets are injected via Cloudflare's secret store or local `.dev.vars`, both gitignored. See each app's README for setup.
